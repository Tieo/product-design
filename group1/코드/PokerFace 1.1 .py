...
def Prefresh0(table, turn, pot):
    ...
    if len(players) == 2:
        ...
        if turn > 0 and op8i == 9:
            screen.blit(db, (985, 120))
        screen.blit(op8money, (980, 80))
        screen.blit(op8pf, (980, 100))
        screen.blit(op8table, (860, 250))
        screen.blit(back, (850, 10))
        screen.blit(back, (800, 10))
        if turn == 4 and players[op8i][2] == 1:
            screen.blit(op8hand[0], (850, 10))
            screen.blit(op8hand[1], (800, 10))
        screen.blit(op8name, (960, 20))
                ...
                if lowlimit < 2000:
                    ...
                    if players[i][0] == 'player':
                        ...
                        while 1:
                            ...
                            if bet == 2000:
                                break
                            block = font.render(text, True, BLACK)
                            rect = block.get_rect()
                            rect.center = screen.get_rect().center
                            screen.blit(block, rect)
                            pg.display.flip()
